...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 OMP_NUM_THREADS=16 OPENBLAS_NUM_THREADS=1 torchrun --nnodes=1 --nproc_per_node=8 --max_restarts=0 \
 ...
 --logdir /fs/nexus-scratch/aliu1237/transfuser/scratch --root_dir /fs/nexus-scratch/aliu1237/transfuser/data \
 --parallel_training 1 --batch_size 32 --save_every 10 --epochs 100 --baseline 'transFuser'

## sbatch -J tfuse_try2 train_baseline_8.sh
## model_10 = epoch 29