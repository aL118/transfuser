...
# Runs script on specific scenario, used to run run scenarios in parallel with the main evaluation
bash /fs/nexus-scratch/aliu1237/transfuser/leaderboard/scripts/local_evaluation_patch.sh

## sbatch -J baseline_metrics ./eval_baseline.sh
## model_10 = epoch 29
