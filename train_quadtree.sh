...
CUDA_VISIBLE_DEVICES=0,1,2,3 OMP_NUM_THREADS=16 OPENBLAS_NUM_THREADS=1 torchrun --nnodes=1 --nproc_per_node=4 --max_restarts=0 \
 ...
 --logdir /fs/nexus-scratch/aliu1237/transfuser/logdir_quadtree --root_dir /fs/nexus-scratch/aliu1237/transfuser/data \
 --parallel_training 1 --batch_size 32 --save_every 10 --epochs 100 --backbone 'quadtree'

## sbatch -J tfuse_quadtree train_quadtree.sh