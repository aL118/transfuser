...
CUDA_VISIBLE_DEVICES=0,1,2,3 OMP_NUM_THREADS=16 OPENBLAS_NUM_THREADS=1 torchrun --nnodes=1 --nproc_per_node=4 --max_restarts=0 \
 ...
 --logdir /fs/nexus-scratch/aliu1237/transfuser/logdir2 --root_dir /fs/nexus-scratch/aliu1237/transfuser/data \
 --load_file /fs/nexus-scratch/aliu1237/transfuser/logdir/transfuser/model_9.pth \
 --parallel_training 1 --batch_size 32

## sbatch -J run_8_gpus my_script8.sh
## model_10 = epoch 29